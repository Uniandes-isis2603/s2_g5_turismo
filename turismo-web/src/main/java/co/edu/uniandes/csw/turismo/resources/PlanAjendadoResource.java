...
public class PlanAjendadoResource {
    ...
    private List<PlanAjendadoDetailDTO> listEntityToDTO(List<PlanAjendadoEntity> entityList) {
        List<PlanAjendadoDetailDTO> list = new ArrayList<>();
        for(PlanAjendadoEntity entity : entityList) {
            list.add(new PlanAjendadoDetailDTO(entity));
        }
        return list;
    }
    /**
