...
{
/**
     * <h1>GET /api/users/{id}/preferences : Obtener preferencias del usuario con id dado.</h1>
     * 
     ...
     * </code>
     * </pre>
     * @param idUsuario Identificador del usuario del cual se desea obtener las pref. Este debe ser una cadena de dígitos.
     ...
     * </pre>
     *
     * @param idPlan Identificador de el Plan del cual se desean obtener las pref. Este debe ser una
     * cadena de dígitos.
     * @return PreferenciasDetailDTO , este contien las preferencias (tipos/categorias) del plan
     */
    @GET
    @Path("/plans/{id: \\d+}/preferences")
    public PreferenciasDetailDTO getPreferencesPlan(@PathParam("id")Long idPlan)
    {
        return new PreferenciasDetailDTO();
    }
   
    /**
     * <h1>PUT /api/users/{id}/preferences : Actualizar preferencias usuario con el id dado.</h1>
    ...
    /**
     * <h1>POST /api/users/{id}/preferences: Crear unas preferencias para el usuario con id dado.</h1>
     *
    ...
    @Path("{/users/id: \\d+}/preferences")
     ...
     /**
     * <h1>POST /api/users/{id}/preferences: Crear unas preferencias para el plan con id dado.</h1>
     *
     * <pre>Cuerpo de petición: JSON {@link PreferencesDetailDTO}.
     *
     * Crea unas preferencias para un plan con id dado con la informacion que se recibe en el cuerpo
     * de la petición y se regresa un objeto identico
     * por la base de datos.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Creó preferencias para el plan con id dado.
     * </code>
     * </pre>
     *
     * @param preferencias {@link PreferenciasDetailDTO} - las preferencias que se desea guardar.
     * @param idPlan al que se le añadiran las preferencias
     * @return JSON {@link PrefernciasDetailDTO} - las preferencias guardadas para plan con id dado
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera cuando se ingresan tipos/ categorias plan que no existen o informacion irrelevante
     */
    @POST
     ...
     * 
     * <pre>Borra las preferencias del plan con el id asociado recibido en la URL.
     * 
     * Códigos de respuesta:<br>
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Elimina las preferencias correspondiente al id de plan dado.</code>
     * <code style="color: #c7254e; background-color: #f9f2f4;">
     * 404 Not Found. No existe un plan con el id dado.
     * </code>
     * </pre>
    ...
    @Path("{/plans/id: \\d+}/preferences")
     ...
     /**
     * <h1>PUT /api/plans/{id}/preferences : Actualizar preferencias para el plan con el id dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link PreferenciasDetailDTO}.
     *
     * Actualiza las preferencias de plan con recibido en la URL con la informacion que se recibe en el cuerpo de la petición.
     *
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     * 200 OK Actualiza las preferencias del plan con el id dado con la información enviada como parámetro. Retorna un objeto identico.</code>
     * <code style="color: #c7254e; background-color: #f9f2f4;">
     * 404 Not Found. No existe una plan con el id dado.
     * </code>
     * </pre>
     *
     * @param idPlan Identificador de el plan que se desea actualizar.Este debe ser
     * una cadena de dígitos.
     * @param preferencias {@link PreferenciasDetailDTO} las preferencias que se desean guardar.
     * @return JSON {@link PreferenciasDetailDTO} - las preferencias guardadas.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} se ingresan tipos de plan que no existen, o datos irrelevantes
    ...
    @PUT
    @Path("/plans/{id: \\d+}/preferences")
    public PreferenciasDetailDTO updatePreferenciaPlan(@PathParam("id")Long idPlan, PreferenciasDetailDTO preferencias) throws BusinessLogicException 
    {
        return preferencias;
    }
}
