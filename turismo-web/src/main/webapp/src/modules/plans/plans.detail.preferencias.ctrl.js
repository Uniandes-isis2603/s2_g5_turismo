(function (ng) {
    ...
    mod.controller('planDetailPreferenciasCtrl', ['$scope', '$http', 'plansContext', '$state',
        /**
         * @ngdoc controller
        ...
        function ($scope, $http, plansContext, $state) {           
             ...
             */
                $http.get(plansContext + '/' + $state.params.planId+ '/preferences').then(function (response) {
                    $scope.currentPreferenceFromPlan = response.data;
                });
            }
        }
    ]);
